...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/utils/sorter.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/utils/</a> sorter.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  function dynamicSort(property) {
    var sortOrder = 1;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (property[0] === '-') {
<span class="cstat-no" title="statement not covered" >      sortOrder = -1;</span>
<span class="cstat-no" title="statement not covered" >      property = property.substr(1);</span>
    }
&nbsp;
    return function(a, b) {
      var result = (a[property] &lt; b[property]) ? -1 : <span class="branch-1 cbranch-no" title="branch not covered" >(a[property] &gt; b[property]) ? 1 : 0;</span>
...
&nbsp;
  ...
  _.each(_.keys(sortCriteria), function(key) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (sortCriteria[key] === -1) <span class="cstat-no" title="statement not covered" >sortArray.push('-' + key);</span>
