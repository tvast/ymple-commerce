...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/ddl.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/</a> ddl.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
   ...
   */
&nbsp;
  alter: <span class="fstat-no" title="function not covered" >function(attributes, cb) {</span>
<span class="cstat-no" title="statement not covered" >    this.adapter.alter(attributes, cb);</span>
  },
&nbsp;
  /**
