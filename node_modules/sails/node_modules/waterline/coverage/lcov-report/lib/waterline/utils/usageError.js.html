...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/utils/usageError.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/utils/</a> usageError.js
    </h1>
    <div class='clearfix'>
...
module.exports = function(err, usage, cb) {
  var message = err + '\n==============================================\nProper usage :: \n' + usage + '\n==============================================\n';
  <span class="missing-if-branch" title="else path not taken" >E</span>if (cb) return cb(message);
