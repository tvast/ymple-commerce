...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/adapters.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/</a> adapters.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
      ...
      self[key] = function() {
&nbsp;
        var tableName = self.tableName || <span class="branch-1 cbranch-no" title="branch not covered" >self.identity;</span>
&nbsp;
        // If this is the teardown method, just pass in the connection name,
        // otherwise pass the connection and the tableName
        var defaultArgs = key === 'teardown' ? <span class="branch-0 cbranch-no" title="branch not covered" >[conn] </span>: [conn, tableName];
&nbsp;
